...
@ApplyOptions<CommandOptions>({
  description: "Uhhhhh... yeah.",
  fullCategory: ["NSFW", "Booru"],
  cooldownDelay: 15000,
  preconditions: ["NotBlacklisted"],
  nsfw: true,
})
export class FootjobCommand extends Command {
  ...
  public override async chatInputRun(interaction: ChatInputCommandInteraction) {
    ...
    await processBooruRequest({ interaction, tags: "footjob -yaoi", site: "gelbooru", noTagsOnReply: true });
  }
}
